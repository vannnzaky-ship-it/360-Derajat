<div class="container-fluid p-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <div>
            <a href="{{ route('admin.rekap-siklus', $siklus->id) }}" class="text-decoration-none text-muted small mb-2 d-block">
    ...
    {{-- KONTEN RAPORT (Adaptasi dari Raport Karyawan) --}}
    <div class="row g-4">
            ...
            <div class="card shadow-sm border-0 bg-custom-brown bg-gradient text-white mb-4">
                <div class="card-body p-4 d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="card-text display-5 fw-bold mb-0">{{ number_format($hasilPenilaian['skor_akhir']) }}</p>
                    </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-3 text-center">
                     ...
                     <p class="mb-0 fw-bold fs-5">
                        @php $score = $hasilPenilaian['skor_akhir']; @endphp
...
<script>
    document.addEventListener('livewire:initialized', () => {
        ...
        // Kita ambil keys (label) dan values (skor) dari array $tableData
