...
// Library Excel & Chart (Copy dari DetailNilai)
...
class DetailPeninjau extends Component
{
    ...
    public function loadRaportData()
    {
        ...
        if ($session) {
            ...
            if ($countJabatan > 0) {
                ...
                // Gunakan Helper Polkam yang sama dengan DetailNilai
    ...
    private function calculateRank($userId, $sessionId, $jabatanIdFilter = 'all') {
        ...
        foreach ($targetIds as $id) {
            ...
            $v = PenilaianAlokasi::where('target_user_id', $id)
                    ...
                    ->where('status_nilai', 'Sudah')->count();
    ...
    // --- Helper Baru (Sesuai DetailNilai) ---
   ...
   public function exportPdf()
    ...
    // --- EXPORT EXCEL (DENGAN GRAFIK + LOGO + PHPSPREADSHEET) ---
